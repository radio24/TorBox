...
echo -e "${WHITE}    The associated menu entries are placed in the configuration sub-menu.${NOCOLOR}"
echo ""
# Remark for TorBox 0.4.1: directly reboot as in run_install_on_ubuntu.sh
