...
sudo apt-get -y install hostapd isc-dhcp-server obfs4proxy usbmuxd wicd dnsmasq dnsutils tcpdump iftop vnstat links2 debian-goodies apt-transport-https dirmngr python3-setuptools ntpdate screen nyx
