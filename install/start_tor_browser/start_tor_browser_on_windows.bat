...
echo user_pref("extensions.torbutton.socks_host", "192.168.42.1"); >> %DEFAULT%\user.js
echo user_pref("extensions.torbutton.socks_port", 9050); >> %DEFAULT%\user.js
echo user_pref("network.proxy.socks", "192.168.42.1"); >> %DEFAULT%\user.js
echo user_pref("network.proxy.socks_port", 9050); >> %DEFAULT%\user.js
echo user_pref("extensions.torbutton.custom.socks_host", "192.168.42.1"); >> %DEFAULT%\user.js
echo user_pref("extensions.torbutton.custom.socks_port", 9050); >> %DEFAULT%\user.js
echo user_pref("extensions.torlauncher.control_host", "192.168.42.1"); >> %DEFAULT%\user.js
