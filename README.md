...
**TorBox Image** (about 1 GB): [v.0.5.4 (20.07.2025)](https://www.torbox.ch/data/torbox-20250720-v054.img.xz) – [SHA-256 values](https://www.torbox.ch/?page_id=1128)<br />
**TorBox mini Image** (about 1 GB): [v.0.5.4 (20.07.2025)](https://www.torbox.ch/data/torbox-mini-20250720-v054.img.xz) – [SHA-256 values](https://www.torbox.ch/?page_id=1128)<br />
**TorBox Menu only**: [v.0.5.4 (20.07.2025)](https://www.torbox.ch/data/torbox054-20250720.zip) – [SHA-256 values](https://www.torbox.ch/?page_id=1128)<br />
...
1. [Download the latest TorBox image file](https://www.torbox.ch/data/torbox-20250720-v054.img.xz) and [verify the integrity of the downloaded file](https://www.torbox.ch/?page_id=1128).
...
[![Start-up instructions](https://www.torbox.ch/wp-content/uploads/2025/04/TorBox-A5-RPI5-054-e1745230819244.png)](https://www.torbox.ch/wp-content/uploads/2025/04/TorBox-A5-RPI5-054.png)
